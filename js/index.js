...
async function getData() {
  ...
  $('#content').on('click', '.item1', function () {
    localStorage.setItem('imgsrc', $(this).find('.imgs').attr('src'));
    localStorage.setItem('sale', $(this).find('.sales1').html());
    localStorage.setItem('name', $(this).find('.names').html());
    localStorage.setItem('price', $(this).find('.price1').html());
